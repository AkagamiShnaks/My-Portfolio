    ...
    <>
      ...
      >
        <a
          ...
          className="text-gray-400 hover:text-purple-400 transition-colors duration-300 vertical-text"
        >
          ayon7930@gmail.com
        </a>
        <div className="w-px h-24 bg-purple-500/20" />
      </motion.div>
      ...
      <motion.div
        className="fixed top-0 left-0 w-full h-1 bg-purple-500 origin-left z-50"
        style={{
...
const MouseFollower = () => {
  ...
  return (
    ...
    >
      <div className="w-full h-full rounded-full border border-purple-400 opacity-50" />
      <div className="absolute inset-2 rounded-full bg-purple-400 blur-sm opacity-20" />
    </motion.div>
  );
};
