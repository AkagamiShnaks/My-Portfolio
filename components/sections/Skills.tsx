  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <p className="text-purple-400 font-mono text-sm tracking-wider mb-4">
            EXPERTISE
          </p>
                ...
                className={`relative p-4 rounded-xl border transition-all duration-300
                  ${
                    selectedCategory === category.id
                      ...
                      : "bg-surface-light border-purple-500/10 text-gray-400 hover:border-purple-500/30"
                  }`}
              >
                {category.icon && (
                  <category.icon className="w-8 h-8 mx-auto mb-3 text-purple-400" />
                )}
          ...
          <AnimatePresence mode="popLayout">
            {filteredSkills.map((skill) => (
              <motion.div
                ...
                className="group relative bg-surface-light rounded-lg p-6 border border-purple-500/10
