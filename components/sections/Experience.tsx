  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 h-full w-px md:w-24">
        <div className="h-full w-px md:h-px bg-gradient-to-r from-purple-500 to-violet-500 opacity-20" />
        <motion.div
          className="absolute left-0 top-0 h-full w-px md:h-px bg-gradient-to-r from-purple-500 to-violet-500"
      ...
      <div className="absolute left-[-4px] md:left-24 top-0">
        <div className="relative w-2 h-2 md:w-3 md:h-3">
          ...
          <div className="absolute inset-[-4px] bg-purple-500 rounded-full opacity-30 animate-pulse" />
        </div>
      </div>
      ...
      <motion.div
        layout
        className="relative bg-surface-light rounded-xl p-6 md:p-8 border border-purple-500/10 
      ...
      >
        ...
        <div
          className="absolute -top-3 left-6 px-4 py-1 bg-surface-dark rounded-full 
                     border border-purple-500/20 text-purple-400 text-sm"
        >
          {experience.duration}
        </div>
        ...
        <div className="pt-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              ...
              <motion.a
                ...
                className="text-purple-400 hover:text-purple-500 transition-colors inline-flex items-center gap-1"
                whileHover={{ x: 5 }}
              >
                {experience.company}
          ...
          <motion.button
            ...
            className="mt-6 text-sm text-purple-400 hover:text-purple-500 transition-colors"
            whileHover={{ x: 5 }}
          >
